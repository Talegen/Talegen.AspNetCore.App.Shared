...
namespace Talegen.AspNetCore.App.Shared.Services.Messaging.Common
{
    ...
    /// <summary>
    /// This class implements the minimum implementation of a common message.
    /// </summary>
    public class CommonMessage : ISenderMessage
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonMessage" /> class.
        /// </summary>
        public CommonMessage()
            : this(new CommonAddress(), new List<ISenderAddress>())
        { 
        }
        ...
        public CommonMessage(string from, string to = "", string subject = "", string textBody = "", string htmlBody = "", string textBodyContentType = "text/plain", string htmlBodyContentType = "text/html")
            : this(new CommonAddress(from), new CommonAddress(to), subject, textBody, htmlBody, textBodyContentType, htmlBodyContentType)
        {
        }
        ...
        /// <param name="textBodyContentType">Contains the optional text body content type value.</param>
        /// <param name="htmlBodyContentType">Contains the optional HTML body content type value.</param>
        public CommonMessage(ISenderAddress from, ISenderAddress to, string subject = "", string textBody = "", string htmlBody = "", string textBodyContentType = "text/plain", string htmlBodyContentType = "text/html")
        ...
        /// <param name="textBodyContentType">Contains the optional text body content type value.</param>
        /// <param name="htmlBodyContentType">Contains the optional HTML body content type value.</param>
        public CommonMessage(ISenderAddress from, List<ISenderAddress> recipients, string subject = "", string textBody = "", string htmlBody = "", bool recipientsVisible = false, string textBodyContentType = "text/plain", string htmlBodyContentType = "text/html")
        {
